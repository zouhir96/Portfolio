...
const Portfolio = () => {
  const portfolioItems = [
    ...
    },
    {
      ...
      type: "Personal project",
      description:
        "Native Android E-commerce application to sell skincare products.",
      technologies: [
        "Kotlin",
        "Coroutines",
        "Compose",
    ...
    },
    {
      ...
      description:
        "Digital cash book, 100% free and secure.<br>Record customers' debts and payments, simplify follow-up and speed up collection.",
      technologies: [
        "Java",
        "RxJava",
        "offline-first",
      ...
      linkToProject:
        "https://play.google.com/store/apps/details?id=com.invyad.konnash&pcampaignid=web_share",
    },
  ];
  return (
