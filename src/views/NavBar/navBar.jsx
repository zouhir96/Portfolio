...
const Links = () => {
    ...
    return (
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 md:ml-auto md:mr-6" id="navbar-sticky">
    ...
    return (
        <nav className="bg-[#E7EFF7] z-10 shadow-md fixed w-full top-0 start-0">
            <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
                <img src="logo.png" alt="Zouhir logo" className="h-8" />
                <div className="flex md:order-2 space-x-2 sm:space-x-3 md:space-x-0 md:gap-2">
                        <Link as={ScrollLink} to="contact" smooth={true} duration={700} offset={-30} className="border p-2 rounded-md md:px-4 text-sm sm:text-base border-[#3C5065] cursor-pointer">Contact</Link>
                            <a href="/cv_zouhir_rajdaoui.pdf" download className="border p-2 rounded-md md:px-4 border-[#3C5065] text-white text-sm sm:text-base bg-[#3C5065]">Download Resume</a>
